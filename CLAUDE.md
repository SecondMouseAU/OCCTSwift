...
divergence (twenty-three on disk, seventeen pinned, as of 2026-09-19) and what each unpinned patch
...
Ten gates, five censuses and one merge-history audit, all pure Python over the repo's own text.
