...
divergence (twenty-seven on disk, seventeen pinned, as of 2026-09-21) and what each unpinned patch
...
Eleven gates, five censuses and one merge-history audit, all pure Python over the repo's own text.
