...
| `legacyOverloadStaysNarrow` | Issue849ShapeFixStatusTests.swift | `ShapeFixStatus / OCCTShapeFixerStatusFlag` | LEGACYWIDE: legacy status(Int) passes any ordinal through | `Issue849ShapeFixStatusTests.swift:90:9: Expectation failed: !fixer.status(4)` | pass | PASS |
| `nullShapeReturnsUnknownSentinel` | Issue870ShapeExtendShapeTypeFailureTests.swift | `OCCTShapeExtendShapeType` | NULLTYPE7: null-shape sentinel 7 (TopAbs_VERTEX) instead of -1 | `Issue870ShapeExtendShapeTypeFailureTests.swift:22:9: Expectation failed: OCCTShapeExtendShapeType(nil, true) == -1` | pass | PASS |
| `sentinelDecodesToUnknownNotVertex` | Issue870ShapeExtendShapeTypeFailureTests.swift | `OCCTShapeExtendShapeType` | NULLTYPE7: null-shape sentinel 7 (TopAbs_VERTEX) instead of -1 | `Issue870ShapeExtendShapeTypeFailureTests.swift:30:9: Expectation failed: ShapeType(rawValue: Int(raw)) == .unknown` | pass | PASS |
