...
| `cylinderFacesUnaffected` | Issue484FaceFixContextTests.swift | `OCCTFaceFix` | FACEFIXNULL: return nullptr before ShapeFix_Face runs | `Issue484FaceFixContextTests.swift:126:29: Issue recorded` | pass | PASS |
