...
| Surface measured continuity (#485) | Analytic surfaces report CN as ordinal 6, not 99 | `OCCTSurfaceGetContinuity` | OCCTSurfaceGetContinuity returns the pre-#485 C-level encoding (C2 as 2, CN as 99) (INJ_485_OLDENC) | Issue485SurfaceContinuityTests.swift:104 plane.continuityClass == .cN | ✅ | MATCH | Rewritten: both fixtures sat behind `if let` |
| Surface measured continuity (#485) | continuity and continuityClass agree on the same surface, in every class | `OCCTSurfaceGetContinuity` | OCCTSurfaceGetContinuity returns the pre-#485 C-level encoding (C2 as 2, CN as 99) (INJ_485_OLDENC) | Issue485SurfaceContinuityTests.swift:124 surface.continuity != 99 | ✅ | MATCH |  |
| Surface measured continuity (#485) | The result vocabulary stays distinct from the two request vocabularies | `(Swift) ContinuityClass` | ContinuityClass g1 and c1 raw values swapped at compile time in a separate build; raw values cannot be switched by environment | Issue485SurfaceContinuityTests.swift:140 ContinuityClass.c1.rawValue != ParametricContinuity.c1.rawValue | ✅ | N/A |  |
