...
| Parametric Plate Surface Tests | Plate through points returns parametric surface | `OCCTSurfacePlateThrough` | point z + 1 (INJ_PT_ZOFF) | ParametricPlateSurfaceTests.swift:29 maxDistance(s, points) < 1e-6 | ✅ | MATCH | Rewritten: `uMax > uMin` passed a plate that missed its points |
| Parametric Plate Surface Tests | Plate through points is evaluable | `OCCTSurfacePlateThrough` | point z + 1 (INJ_PT_ZOFF) | ParametricPlateSurfaceTests.swift:49 abs(pt.z) < 1e-9 | ✅ | MATCH | Rewritten: finite coordinates only |
...
| Parametric Plate Surface Tests | Plate through with custom degree | `OCCTSurfacePlateThrough` | point z + 1 (INJ_PT_ZOFF) | ParametricPlateSurfaceTests.swift:71 maxDistance(s, points) < 1e-3 | ✅ | MATCH | Rewritten: asserted only non-nil |
