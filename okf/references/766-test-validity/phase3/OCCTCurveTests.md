...
|---|---|---|---|---|---|---|---|
| Law Function Tests | Linear law default parameter range 0...1 | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawval: LawFunction.value + 1e-3 | `LawFunctionTests.swift:88 abs(law.value(at: 0.5) - 5) < 1e-6` | ✅ | MATCH |  |
...
| Law Function Tests | Interpolated law passes through points | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawval: LawFunction.value + 1e-3 | `LawFunctionTests.swift:54 abs(law.value(at: 0)) < 1e-3  (+1 more)` | ✅ | MATCH |  |
...
| Law Function Tests | BSpline law creation | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawval: LawFunction.value + 1e-3 | `LawFunctionTests.swift:77 abs(law.value(at: 0) - 1.0) < 1e-6  (+1 more)` | ✅ | MATCH |  |
...
| Law Function Tests | BSpline law rejects a shorter multiplicities array | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawmult: mismatched multiplicities padded to the knot count | `LawFunctionTests.swift:102 law == nil` | ✅ | N/A |  |
| Law Function Tests | BSpline law rejects a longer multiplicities array | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawmult: mismatched multiplicities padded to the knot count | `LawFunctionTests.swift:110 law == nil` | ✅ | N/A |  |
| Law Function Tests | Interpolated law needs at least 2 points | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawinterp1: one point answers a constant law | `LawFunctionTests.swift:63 law == nil` | ✅ | N/A |  |
| Law Composite Tests | bsplineKnotSplitting | `OCCTLawFunctionValue / Bounds / Create* / OCCTLawComposite / OCCTLawBSplineKnotSplitting` | lawnone: knot splitting always -1 | `LawCompositeTests.swift:42 splits.count == 3` | ✅ | MATCH |  |
