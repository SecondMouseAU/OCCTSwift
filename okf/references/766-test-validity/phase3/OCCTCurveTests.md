...
|---|---|---|---|---|---|---|---|
| Curve3D *Properties views keep their parent alive (#965) | a view outliving its parent still reads the right values | `OCCTCurve3DCircleRadius, OCCTCurve3DCircleCenter` | cpradius: CircleProperties.radius x 1.01 | `Issue965Curve3DPropertyLifetimeTests.swift:83 result.view.radius == Self.radius` | ✅ | MATCH |  |
| Curve3D *Properties views keep their parent alive (#965) | a setter called through a view is visible on the parent | `OCCTCurve3DCircleSetRadius, OCCTCurve3DCircleRadius` | cpradius: CircleProperties.radius x 1.01 | `Issue965Curve3DPropertyLifetimeTests.swift:112 curve.circleProperties.radius == 8` | ✅ | MATCH |  |
| Curve3D *Properties views keep their parent alive (#965) | the chained access the issue reports reads the right radius | `OCCTEdgeGetCurve3D, OCCTCurve3DCircleRadius` | cpradius: CircleProperties.radius x 1.01 | `Issue965Curve3DPropertyLifetimeTests.swift:48 edge.curve3D?.circleProperties.radius == Self.radius` | ✅ | MATCH |  |
| Curve3D *Properties views keep their parent alive (#965) | a view outliving its parent survives 400 intervening allocations | `OCCTCurve3DCircleRadius` | cpradius: CircleProperties.radius x 1.01 | `Issue965Curve3DPropertyLifetimeTests.swift:100 result.view.radius == Self.radius` | ✅ | MATCH |  |
| Curve3D *Properties views keep their parent alive (#965) | every Curve3D *Properties accessor keeps its parent alive | `none: Swift view structs (Curve3D.*Properties(owner:)) retain their parent; the assertion reaches no bridge call` | cpcopy: lineProperties holds a copy, not its parent | `Issue965Curve3DPropertyLifetimeTests.swift:70 result.parentAlive` | ✅ | N/A |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | type 5, mirror through a plane | `OCCTCurve3DMirrorPlane, OCCTCurve3DTransform, OCCTSurfaceMirrorPlane, OCCTSurfaceTransform (each through occtBuildTrsf3D type 5)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:77 abs(got.z - expected.z) < 1e-9  (+3 more)` | ✅ | MATCH |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | type 4, mirror through an axis | `OCCTCurve3DMirrorAxis, OCCTCurve3DTransform, OCCTSurfaceMirrorAxis, OCCTSurfaceTransform (each through occtBuildTrsf3D type 4)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:75 abs(got.x - expected.x) < 1e-9  (+7 more)` | ✅ | MATCH |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | type 1, rotation | `OCCTCurve3DRotate, OCCTCurve3DTransform, OCCTSurfaceRotate, OCCTSurfaceTransform (each through occtBuildTrsf3D type 1)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:75 abs(got.x - expected.x) < 1e-9  (+7 more)` | ✅ | MATCH |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | type 3, mirror through a point | `OCCTCurve3DMirrorPoint, OCCTCurve3DTransform, OCCTSurfaceMirrorPoint, OCCTSurfaceTransform (each through occtBuildTrsf3D type 3)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:75 abs(got.x - expected.x) < 1e-9  (+11 more)` | ✅ | MATCH |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | type 0, translation | `OCCTCurve3DTranslate, OCCTCurve3DTransform, OCCTSurfaceTranslate, OCCTSurfaceTransform (each through occtBuildTrsf3D type 0)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:75 abs(got.x - expected.x) < 1e-9  (+11 more)` | ✅ | MATCH |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | type 2, scale | `OCCTCurve3DScale, OCCTCurve3DTransform, OCCTSurfaceScale, OCCTSurfaceTransform (each through occtBuildTrsf3D type 2)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:75 abs(got.x - expected.x) < 1e-9  (+11 more)` | ✅ | MATCH |  |
| 3D transforms: one discriminated gp_Trsf builder (#995) | The six type codes are six different transforms of the same point | `OCCTCurve3DTranslate, OCCTCurve3DRotate, OCCTCurve3DScale, OCCTCurve3DMirrorPoint, OCCTCurve3DMirrorAxis, OCCTCurve3DMirrorPlane (through occtBuildTrsf3D types 0 to 5)` | trsfid: occtBuildTrsf3D leaves every type as the identity | `Issue995BuildTrsf3DTests.swift:197 sqrt(apart.x * apart.x + apart.y * apart.y + apart.z * apart` | ✅ | MATCH |  |
