...
| Stress: evalAndUpdateTolerance Null PCurve | `edgePairedWithAnUnrelatedPlanarFaceDoesNotCrash` | `OCCTBRepToolsEvalAndUpdateTol` | OCCTBRepToolsEvalAndUpdateTol returns the edge tolerance without evaluating | StressNullInvalidTests.swift:644 Expectation failed: abs(got - want) < 1e-9 | ✔ | MATCH | yes |
