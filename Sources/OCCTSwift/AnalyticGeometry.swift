...
public enum PlaneGeometry {
    ...
    public static func containsPoint(
        planeOrigin: SIMD3<Double>, planeNormal: SIMD3<Double>,
        point: SIMD3<Double>, tolerance: Double = 1e-7
    ) -> Bool {
        OCCTPlaneContainsPoint(
            planeOrigin.x, planeOrigin.y, planeOrigin.z,
            planeNormal.x, planeNormal.y, planeNormal.z,
