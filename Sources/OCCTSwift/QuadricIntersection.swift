...
public enum QuadricIntersection {
    ...
    public static func cylinderSphereIdentical(
        cylinderRadius: Double,
        sphereCenter: SIMD3<Double>, sphereRadius: Double,
        tolerance: Double = 1e-6
    ) -> Bool {
        OCCTIntAnaCylinderSphereIdentical(
            cylinderRadius,
            sphereCenter.x, sphereCenter.y, sphereCenter.z,
            sphereRadius, tolerance)
    }
...
extension QuadricIntersection {
    ...
    public static func coneSpherePoints(
        ...
        sphereCenter: SIMD3<Double>, sphereRadius: Double,
        tolerance: Double = 1e-6,
        curveIndex: Int, sampleCount: Int
    ) -> [SIMD3<Double>] {
    ...
    public static func coneSphereIsOpen(
        semiAngle: Double, refRadius: Double,
        sphereCenter: SIMD3<Double>, sphereRadius: Double,
        tolerance: Double = 1e-6, curveIndex: Int
    ) -> Bool {
        OCCTIntAnaConeSphereIsOpen(
            semiAngle, refRadius,
            sphereCenter.x, sphereCenter.y, sphereCenter.z,
    ...
    public static func coneSphereDomain(
        semiAngle: Double, refRadius: Double,
        sphereCenter: SIMD3<Double>, sphereRadius: Double,
        tolerance: Double = 1e-6, curveIndex: Int
    ) -> ClosedRange<Double> {
