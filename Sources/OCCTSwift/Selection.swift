...
public struct RayHit: Sendable {
    ...
    ///
    /// False only at a genuinely singular point of the surface.
    ///
    /// Until #529 it was also false.
...
extension Shape {
    ...
    /// Shape expects.
    ///
    /// It is meaningful only against the shape it came from: an index taken from
