...
/// generated.isEmpty` for each one.
///
/// An edge OCCT actually filleted is always deleted, with the new.
/// fillet-boundary edges in generated (measured: 12/12 on the fixture below).
///
/// Do **not** test.
...
///
/// Used by tools that need to track.
