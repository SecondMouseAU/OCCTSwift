...
///
/// An empty result has four causes that are not distinguished here: the pair
/// is too close together to have a bisector, the bisectors are parallel, they cross off a kept ray,.
/// or they coincide and the overlap is not a point.
///
/// See `docs/reference/Shape-Recognition.md` for.
...
/// - Returns: The crossing, or an empty array.
///
/// Two distinct half-lines meet at most once.
///
/// ```swift.
