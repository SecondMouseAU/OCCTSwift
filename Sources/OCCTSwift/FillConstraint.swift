...
///
/// Pairs an edge with the face the filled surface should be continuous with.
///
/// Tangency and.
...
public struct FillConstraint {
    ...
    /// quietly substituting a different surface.
    ///
    /// Leave it nil to accept whichever surface the.
