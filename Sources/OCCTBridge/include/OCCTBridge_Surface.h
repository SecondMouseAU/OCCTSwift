...
// Evaluation
void OCCTSurfaceGetPoint(OCCTSurfaceRef surface,
                         double         u,
                         double         v,
                         double*        x,
                         double*        y,
                         double*        z);
void OCCTSurfaceD1(OCCTSurfaceRef surface,
                   double         u,
                   double         v,
                   double*        px,
                   double*        py,
                   ...
                   double*        dvy,
                   double*        dvz);
void OCCTSurfaceD2(OCCTSurfaceRef surface,
                   double         u,
                   double         v,
                   double*        px,
                   double*        py,
                   ...
                   double*        d2uvy,
                   double*        d2uvz);
bool OCCTSurfaceGetNormal(OCCTSurfaceRef surface,
                          double         u,
                          double         v,
                          double*        nx,
                          double*        ny,
...
// Operations
OCCTSurfaceRef OCCTSurfaceTrim(OCCTSurfaceRef surface, double u1, double u2, double v1, double v2);
OCCTSurfaceRef OCCTSurfaceOffset(OCCTSurfaceRef surface, double distance);
OCCTSurfaceRef OCCTSurfaceTranslate(OCCTSurfaceRef surface, double dx, double dy, double dz);
...
OCCTSurfaceRef OCCTSurfaceMirrorPlane(OCCTSurfaceRef surface,
                                      ...
                                      double         ny,
                                      double         nz);
OCCTSurfaceRef OCCTSurfaceMirrorPoint(OCCTSurfaceRef surface, double px, double py, double pz);
...
OCCTSurfaceRef OCCTSurfaceApproximate(OCCTSurfaceRef surface,
                                      double         tolerance,
                                      int32_t        continuity,
                                      int32_t        maxSegments,
                                      int32_t        maxDegree);
...
int32_t OCCTSurfaceDrawMesh(OCCTSurfaceRef surface, int32_t uCount, int32_t vCount, double* outXYZ);
...
/// of every point of every plane, cylinder and cone -- whole surfaces reading as "no answer"
/// (#595). Same shape as their OCCTFaceGetGaussianCurvature / OCCTFaceGetMeanCurvature
/// counterparts.
bool OCCTSurfaceGetGaussianCurvature(OCCTSurfaceRef surface,
                                     double         u,
                                     double         v,
                                     double* _Nonnull curvature);
bool OCCTSurfaceGetMeanCurvature(OCCTSurfaceRef surface,
                                 double         u,
                                 double         v,
                                 double* _Nonnull curvature);
bool OCCTSurfaceGetPrincipalCurvatures(OCCTSurfaceRef surface,
                                       double         u,
                                       double         v,
                                       double*        kMin,
                                       double*        kMax,
...
/// @return Surface handle, or NULL on failure
OCCTSurfaceRef _Nullable OCCTSurfaceConicalFromAxis(double axisX,
                                                    double axisY,
                                                    double axisZ,
                                                    double dirX,
                                                    double dirY,
...
/// @return Surface handle, or NULL on failure
OCCTSurfaceRef _Nullable OCCTSurfaceConicalFromPointsRadii(double p1x,
                                                           double p1y,
                                                           double p1z,
                                                           double p2x,
                                                           double p2y,
...
OCCTSurfaceRef _Nullable OCCTSurfaceCylindricalFromAxis(double axisX,
                                                        double axisY,
                                                        double axisZ,
                                                        double dirX,
                                                        double dirY,
...
OCCTSurfaceRef _Nullable OCCTSurfaceCylindricalFromPoints(double p1x,
                                                          double p1y,
                                                          double p1z,
                                                          double p2x,
                                                          double p2y,
...
OCCTSurfaceRef _Nullable OCCTSurfacePlaneFromPoints(double p1x,
                                                    double p1y,
                                                    double p1z,
                                                    double p2x,
                                                    double p2y,
...
OCCTSurfaceRef _Nullable OCCTSurfacePlaneFromPointNormal(double px,
                                                         double py,
                                                         double pz,
                                                         double nx,
                                                         double ny,
...
OCCTSurfaceRef _Nullable OCCTSurfaceTrimmedCone(double p1x,
                                                double p1y,
                                                double p1z,
                                                double p2x,
                                                double p2y,
...
OCCTSurfaceRef _Nullable OCCTSurfaceTrimmedCylinder(double axisX,
                                                    double axisY,
                                                    double axisZ,
                                                    double dirX,
                                                    double dirY,
...
/// @param tolerance Recognition tolerance
OCCTSurfaceAnalyticalResult OCCTSurfaceConvertToAnalytical(OCCTSurfaceRef surface,
                                                           double         tolerance);
...
OCCTTrihedronFrame OCCTGeomFillDarbouxTrihedron(OCCTShapeRef _Nonnull edgeShape,
                                                OCCTShapeRef _Nonnull faceShape,
                                                double param);
...
OCCTTrihedronFrame OCCTGeomFillConstantBiNormalTrihedron(OCCTShapeRef _Nonnull edgeShape,
                                                         double param,
                                                         double biNormalX,
                                                         double biNormalY,
                                                         double biNormalZ);
...
/// @return Surface handle, or NULL on failure
OCCTSurfaceRef _Nullable OCCTGeomFillNSections(const OCCTCurve3DRef _Nonnull* _Nonnull curveRefs,
...
void OCCTGeomFillNSectionsInfo(const OCCTCurve3DRef _Nonnull* _Nonnull curveRefs,
                               const double* _Nonnull params,
                               int32_t count,
                               int32_t* _Nonnull outNbPoles,
                               int32_t* _Nonnull outNbKnots,
...
OCCTSurfaceRef _Nullable OCCTGeomFillGenerator(const OCCTCurve3DRef _Nonnull* _Nonnull curves,
                                               int32_t curveCount,
                                               double  tolerance);
...
bool OCCTGeomFillBoundWithSurfEvaluate(OCCTSurfaceRef _Nonnull surface,
...
bool OCCTGeomLibPlanarSurfacePlane(OCCTSurfaceRef _Nonnull surface,
                                   double tolerance,
                                   double* _Nonnull ox,
                                   double* _Nonnull oy,
                                   double* _Nonnull oz,
...
OCCTExtremaExtPSResult OCCTExtremaExtPS(double px,
                                        double py,
                                        double pz,
...
void OCCTElSLibD1OnSphere(double u,
                          ...
                          double* _Nonnull outVuX,
                          double* _Nonnull outVuY,
                          double* _Nonnull outVuZ,
                          double* _Nonnull outVvX,
                          double* _Nonnull outVvY,
                          double* _Nonnull outVvZ);
...
OCCTSurfaceRef _Nullable OCCTConvertSphereToBSplineSurface(double ox,
                                                           double oy,
                                                           double oz,
                                                           double nx,
                                                           double ny,
...
OCCTSurfaceRef _Nullable OCCTConvertCylinderToBSplineSurface(double ox,
                                                             double oy,
                                                             double oz,
                                                             double nx,
                                                             double ny,
...
OCCTSurfaceRef _Nullable OCCTConvertConeToBSplineSurface(double ox,
                                                         double oy,
                                                         double oz,
                                                         double nx,
                                                         double ny,
...
OCCTSurfaceRef _Nullable OCCTConvertTorusToBSplineSurface(double ox,
                                                          double oy,
                                                          double oz,
                                                          double nx,
                                                          double ny,
...
double OCCTSurfaceUVFromIso(OCCTSurfaceRef _Nonnull surface,
                            double px,
                            double py,
                            double pz,
                            double preci,
...
/// degenerate iso-line, and whether it is U-iso. `preci` is in/out. Returns false if num out of
/// range.
bool OCCTSurfaceSingularityDetail(OCCTSurfaceRef _Nonnull surface,
                                  int32_t num,
                                  double* _Nonnull preci,
                                  double* _Nonnull px,
                                  double* _Nonnull py,
                                  double* _Nonnull pz,
                                  ...
                                  double* _Nonnull firstPar,
                                  double* _Nonnull lastPar,
...
bool OCCTSurfaceProjectDegenerated(OCCTSurfaceRef _Nonnull surface,
                                   double px,
                                   double py,
                                   double pz,
                                   double preci,
...
double OCCTSurfaceProjectPointUVInDomain(OCCTSurfaceRef _Nonnull surface,
                                         double px,
                                         double py,
                                         double pz,
                                         double preci,
...
bool OCCTBRepGPropFaceIntegrationOrders(OCCTShapeRef _Nonnull face,
                                        int32_t* _Nonnull uOrder,
                                        int32_t* _Nonnull vOrder);

/// BRepGProp_Face U-direction integration knots; fills up to maxCount, returns the count.
int32_t OCCTBRepGPropFaceUKnots(OCCTShapeRef _Nonnull face,
                                double* _Nullable buffer,
                                int32_t maxCount);

/// BRepGProp_Face V-direction integration knots (companion to UKnots); fills up to maxCount,
/// returns count.
int32_t OCCTBRepGPropFaceVKnots(OCCTShapeRef _Nonnull face,
                                double* _Nullable buffer,
                                int32_t maxCount);

/// BRepGProp_Face precision-driven surface integration parameters: order (points) for tolerance
/// `eps`, and the U / V subinterval counts. Returns false if `face` is not a face.
bool OCCTBRepGPropFaceSurfaceIntegration(OCCTShapeRef _Nonnull face,
                                         double eps,
                                         int32_t* _Nonnull order,
                                         int32_t* _Nonnull uSubs,
                                         int32_t* _Nonnull vSubs);

/// BRepGProp_Face boundary (edge-loaded) integration: loads face edge #edgeIndex as the boundary
/// arc and returns its integration order (for tolerance `eps`), subinterval count, and knots (up to
/// maxKnots into knotBuffer). Returns false if the face/edge is invalid or the edge can't be
/// loaded.
bool OCCTBRepGPropFaceBoundaryIntegration(OCCTShapeRef _Nonnull face,
                                          int32_t edgeIndex,
                                          double  eps,
                                          int32_t* _Nonnull order,
                                          int32_t* _Nonnull subs,
                                          double* _Nullable knotBuffer,
                                          int32_t maxKnots,
...
OCCTSurfaceRef _Nullable OCCTGCMakeConicalSurface(double cx,
                                                  double cy,
                                                  double cz,
                                                  double nx,
                                                  double ny,
...
OCCTSurfaceRef _Nullable OCCTGCMakeConicalSurface2Pts(double x1,
                                                      double y1,
                                                      double z1,
                                                      double x2,
                                                      double y2,
...
OCCTSurfaceRef _Nullable OCCTGCMakeConicalSurface4Pts(double x1,
                                                      double y1,
                                                      double z1,
                                                      double x2,
                                                      double y2,
...
OCCTSurfaceRef _Nullable OCCTGCMakeCylindricalSurface(double cx,
                                                      double cy,
                                                      double cz,
                                                      double nx,
                                                      double ny,
...
/// Create a cylindrical surface from 3 points.
OCCTSurfaceRef _Nullable OCCTGCMakeCylindricalSurface3Pts(double x1,
                                                          double y1,
                                                          double z1,
                                                          double x2,
                                                          double y2,
...
OCCTSurfaceRef _Nullable OCCTGCMakeCylindricalSurfaceFromCircle(double cx,
                                                                double cy,
                                                                double cz,
                                                                double nx,
                                                                double ny,
...
OCCTSurfaceRef _Nullable OCCTGCMakeCylindricalSurfaceParallel(double cx,
                                                              double cy,
                                                              double cz,
                                                              double nx,
                                                              double ny,
...
OCCTSurfaceRef _Nullable OCCTGCMakeCylindricalSurfaceAxis(double px,
                                                          double py,
                                                          double pz,
                                                          double dx,
                                                          double dy,
...
OCCTSurfaceRef _Nullable OCCTGCMakeTrimmedCone2Pts(double x1,
                                                   double y1,
                                                   double z1,
                                                   double x2,
                                                   double y2,
...
OCCTSurfaceRef _Nullable OCCTGCMakeTrimmedCone4Pts(double x1,
                                                   double y1,
                                                   double z1,
                                                   double x2,
                                                   double y2,
...
OCCTSurfaceRef _Nullable OCCTGCMakeTrimmedCylinderCircle(double cx,
                                                         double cy,
                                                         double cz,
                                                         double nx,
                                                         double ny,
...
OCCTSurfaceRef _Nullable OCCTGCMakeTrimmedCylinderAxis(double px,
                                                       double py,
                                                       double pz,
                                                       double dx,
                                                       double dy,
...
OCCTSurfaceRef _Nullable OCCTGCMakeTrimmedCylinder3Pts(double x1,
                                                       double y1,
                                                       double z1,
                                                       double x2,
                                                       double y2,
...
void OCCTSurfaceGetNBounds(OCCTSurfaceRef _Nonnull surface,
                           int32_t* _Nonnull uSpans,
                           int32_t* _Nonnull vSpans);
...
void OCCTSurfaceBSplineGetPole(OCCTSurfaceRef _Nonnull surface,
                               int32_t uIndex,
                               int32_t vIndex,
                               double* _Nonnull x,
                               double* _Nonnull y,
...
bool OCCTSurfaceBSplineSetPole(OCCTSurfaceRef _Nonnull surface,
                               int32_t uIndex,
                               int32_t vIndex,
                               double  x,
                               double  y,
...
bool OCCTSurfaceBSplineSetWeight(OCCTSurfaceRef _Nonnull surface,
                                 int32_t uIndex,
                                 int32_t vIndex,
                                 double  weight);

/// Insert a U knot.
bool OCCTSurfaceBSplineInsertUKnot(OCCTSurfaceRef _Nonnull surface,
                                   double  u,
                                   int32_t mult,
                                   double  tol);

/// Insert a V knot.
bool OCCTSurfaceBSplineInsertVKnot(OCCTSurfaceRef _Nonnull surface,
                                   double  v,
                                   int32_t mult,
                                   double  tol);

/// Segment the BSpline surface to [u1,u2] x [v1,v2].
bool OCCTSurfaceBSplineSegment(OCCTSurfaceRef _Nonnull surface,
                               double u1,
                               double u2,
                               double v1,
                               double v2);
...
void OCCTSurfacePlaneCoefficients(OCCTSurfaceRef _Nonnull surface,
                                  double* _Nonnull A,
                                  double* _Nonnull B,
                                  double* _Nonnull C,
                                  double* _Nonnull D);
...
void OCCTSurfacePlanePln(OCCTSurfaceRef _Nonnull surface,
                         double* _Nonnull px,
                         double* _Nonnull py,
                         double* _Nonnull pz,
                         double* _Nonnull nx,
...
void OCCTSurfaceSphereCenter(OCCTSurfaceRef _Nonnull surface,
                             double* _Nonnull x,
                             double* _Nonnull y,
                             double* _Nonnull z);
...
void OCCTSurfaceSphereSphere(OCCTSurfaceRef _Nonnull surface,
                             double* _Nonnull cx,
                             double* _Nonnull cy,
                             double* _Nonnull cz,
                             double* _Nonnull radius);
...
void OCCTSurfaceTorusAxis(OCCTSurfaceRef _Nonnull surface,
                          double* _Nonnull px,
                          double* _Nonnull py,
                          double* _Nonnull pz,
                          double* _Nonnull dx,
...
void OCCTSurfaceRevolutionAxis(OCCTSurfaceRef _Nonnull surface,
                               double* _Nonnull px,
                               double* _Nonnull py,
                               double* _Nonnull pz,
                               double* _Nonnull dx,
...
void OCCTSurfaceRevolutionLocation(OCCTSurfaceRef _Nonnull surface,
                                   double* _Nonnull x,
                                   double* _Nonnull y,
                                   double* _Nonnull z);
...
void OCCTSurfaceCylinderAxis(OCCTSurfaceRef _Nonnull surface,
                             double* _Nonnull px,
                             double* _Nonnull py,
                             double* _Nonnull pz,
                             double* _Nonnull dx,
...
void OCCTSurfaceConeApex(OCCTSurfaceRef _Nonnull surface,
                         double* _Nonnull x,
                         double* _Nonnull y,
                         double* _Nonnull z);

/// Get the axis of a Geom_ConicalSurface.
void OCCTSurfaceConeAxis(OCCTSurfaceRef _Nonnull surface,
                         double* _Nonnull px,
                         double* _Nonnull py,
                         double* _Nonnull pz,
                         double* _Nonnull dx,
...
void OCCTSurfaceSweptDirection(OCCTSurfaceRef _Nonnull surface,
                               double* _Nonnull dx,
                               double* _Nonnull dy,
                               double* _Nonnull dz);
...
void OCCTSurfaceEvalD0(OCCTSurfaceRef _Nonnull surface,
                       double u,
                       double v,
                       double* _Nonnull x,
                       double* _Nonnull y,
...
void OCCTSurfaceEvalD1(OCCTSurfaceRef _Nonnull surface,
                       double u,
                       double v,
                       double* _Nonnull px,
                       double* _Nonnull py,
                       double* _Nonnull pz,
                       double* _Nonnull d1ux,
                       double* _Nonnull d1uy,
                       double* _Nonnull d1uz,
                       double* _Nonnull d1vx,
                       double* _Nonnull d1vy,
                       double* _Nonnull d1vz);

/// Evaluate surface at (u, v), returning point, D1U, D1V, D2U, D2V, D2UV.
void OCCTSurfaceEvalD2(OCCTSurfaceRef _Nonnull surface,
                       double u,
                       double v,
                       double* _Nonnull px,
                       double* _Nonnull py,
                       ...
                       double* _Nonnull d1vy,
                       double* _Nonnull d1vz,
                       double* _Nonnull d2ux,
                       double* _Nonnull d2uy,
                       double* _Nonnull d2uz,
                       double* _Nonnull d2vx,
                       double* _Nonnull d2vy,
                       double* _Nonnull d2vz,
                       double* _Nonnull d2uvx,
                       double* _Nonnull d2uvy,
                       double* _Nonnull d2uvz);

/// Create a curve-on-edge adaptor.
OCCTBiTgteCurveOnEdgeRef _Nullable OCCTBiTgteCurveOnEdgeCreate(OCCTShapeRef _Nonnull edgeOnFace,
...
void OCCTBiTgteCurveOnEdgeValue(OCCTBiTgteCurveOnEdgeRef _Nonnull curve,
                                double u,
                                double* _Nonnull x,
                                double* _Nonnull y,
                                double* _Nonnull z);
...
void OCCTProjOnSurfPoint(OCCTProjOnSurfRef _Nonnull proj,
                         int32_t index,
                         double* _Nonnull x,
                         double* _Nonnull y,
                         double* _Nonnull z);
...
void OCCTProjOnSurfParameters(OCCTProjOnSurfRef _Nonnull proj,
                              int32_t index,
                              double* _Nonnull u,
                              double* _Nonnull v);
...
void OCCTIntCSPoint(OCCTIntCSRef _Nonnull intcs,
                    int32_t index,
                    double* _Nonnull x,
                    double* _Nonnull y,
                    double* _Nonnull z,
...
void OCCTSurfaceBSplineGetWeights(OCCTSurfaceRef _Nonnull surface,
                                  ...
                                  int32_t* _Nonnull rows,
                                  int32_t* _Nonnull cols);
...
void OCCTSurfaceDN(OCCTSurfaceRef _Nonnull surface,
                   double  u,
                   double  v,
                   int32_t nu,
                   int32_t nv,
...
void OCCTSurfaceNormal(OCCTSurfaceRef _Nonnull surface,
                       double u,
                       double v,
                       double* _Nonnull nx,
                       double* _Nonnull ny,
...
bool OCCTSurfaceCurvatures(OCCTSurfaceRef _Nonnull surface,
                           double u,
                           double v,
...
void OCCTSurfaceBezierGetPole(OCCTSurfaceRef _Nonnull surface,
                              int32_t uIndex,
                              int32_t vIndex,
                              double* _Nonnull x,
                              double* _Nonnull y,
...
bool OCCTSurfaceBezierSetPole(OCCTSurfaceRef _Nonnull surface,
                              int32_t uIndex,
                              int32_t vIndex,
                              double  x,
                              double  y,
...
bool OCCTSurfaceBezierSetWeight(OCCTSurfaceRef _Nonnull surface,
                                int32_t uIndex,
                                int32_t vIndex,
                                double  weight);
...
void OCCTSurfaceBSplineResolution(OCCTSurfaceRef _Nonnull surface,
                                  double tolerance3d,
...
bool OCCTSurfaceBSplineIncreaseUMultiplicity(OCCTSurfaceRef _Nonnull surface,
                                             int32_t index,
                                             int32_t mult);

/// Increase V multiplicity at knot index to at least mult (1-based).
bool OCCTSurfaceBSplineIncreaseVMultiplicity(OCCTSurfaceRef _Nonnull surface,
                                             int32_t index,
                                             int32_t mult);
...
void OCCTSurfaceBSplineLocalD0(OCCTSurfaceRef _Nonnull surface,
                               double  u,
                               double  v,
                               int32_t fromUK1,
                               int32_t toUK2,
...
void OCCTSurfaceBSplineLocalD1(OCCTSurfaceRef _Nonnull surface,
                               double  u,
                               double  v,
                               int32_t fromUK1,
                               int32_t toUK2,
...
void OCCTSurfaceBSplineLocalD2(OCCTSurfaceRef _Nonnull surface,
                               double  u,
                               double  v,
                               int32_t fromUK1,
                               int32_t toUK2,
...
void OCCTSurfaceBSplineLocalD3(OCCTSurfaceRef _Nonnull surface,
                               double  u,
                               double  v,
                               int32_t fromUK1,
                               int32_t toUK2,
                               ...
                               double* _Nonnull d2uvy,
                               double* _Nonnull d2uvz,
                               double* _Nonnull d3ux,
                               double* _Nonnull d3uy,
                               double* _Nonnull d3uz,
                               double* _Nonnull d3vx,
                               double* _Nonnull d3vy,
                               double* _Nonnull d3vz,
                               double* _Nonnull d3uuvx,
                               double* _Nonnull d3uuvy,
                               double* _Nonnull d3uuvz,
                               double* _Nonnull d3uvvx,
                               double* _Nonnull d3uvvy,
                               double* _Nonnull d3uvvz);

/// Local derivative DN within knot span.
void OCCTSurfaceBSplineLocalDN(OCCTSurfaceRef _Nonnull surface,
                               double  u,
                               double  v,
                               int32_t fromUK1,
                               int32_t toUK2,
...
void OCCTSurfaceBSplineLocalValue(OCCTSurfaceRef _Nonnull surface,
                                  double  u,
                                  double  v,
                                  int32_t fromUK1,
                                  int32_t toUK2,
...
void OCCTSurfaceBSplineLocateU(OCCTSurfaceRef _Nonnull surface,
                               double u,
                               double paramTol,
                               int32_t* _Nonnull i1,
                               int32_t* _Nonnull i2);
...
void OCCTSurfaceBSplineLocateV(OCCTSurfaceRef _Nonnull surface,
                               double v,
                               double paramTol,
                               int32_t* _Nonnull i1,
                               int32_t* _Nonnull i2);
...
/// Get all poles as flat array (x1,y1,z1,x2,...). Array must be pre-allocated to
/// NbUPoles*NbVPoles*3.
...
/// Get all weights as flat array. Array must be pre-allocated to NbUPoles*NbVPoles. Returns false
/// if non-rational.
...
bool OCCTSurfaceBezierInsertPoleColAfter(OCCTSurfaceRef _Nonnull surface,
                                         int32_t colIndex,
                                         const double* _Nonnull poles,
                                         int32_t poleCount);

/// Insert a pole row after index in a Bezier surface.
bool OCCTSurfaceBezierInsertPoleRowAfter(OCCTSurfaceRef _Nonnull surface,
                                         int32_t rowIndex,
                                         const double* _Nonnull poles,
                                         int32_t poleCount);
...
bool OCCTSurfaceBezierSetPoleColWeights(OCCTSurfaceRef _Nonnull surface,
                                        int32_t vIndex,
                                        const double* _Nonnull poles,
...
bool OCCTSurfaceBezierSetPoleRowWeights(OCCTSurfaceRef _Nonnull surface,
                                        int32_t uIndex,
                                        const double* _Nonnull poles,
                                        const double* _Nonnull weights,
                                        int32_t count);
...
bool OCCTSurfaceTransform(OCCTSurfaceRef _Nonnull surface,
...
bool OCCTSurfaceBSplineSetWeightCol(OCCTSurfaceRef _Nonnull surface,
                                    int32_t vIndex,
                                    const double* _Nonnull weights,
                                    int32_t count);

/// Set a row of weights on a BSpline surface. uIndex is 1-based. count = NbVPoles.
bool OCCTSurfaceBSplineSetWeightRow(OCCTSurfaceRef _Nonnull surface,
                                    int32_t uIndex,
                                    const double* _Nonnull weights,
                                    int32_t count);
...
/// Insert a pole column before index in a Bezier surface. poles: flat [x,y,z,...], count =
/// NbUPoles.
bool OCCTSurfaceBezierInsertPoleColBefore(OCCTSurfaceRef _Nonnull surface,
                                          int32_t colIndex,
                                          const double* _Nonnull poles,
                                          int32_t poleCount);

/// Insert a pole row before index in a Bezier surface. poles: flat [x,y,z,...], count = NbVPoles.
bool OCCTSurfaceBezierInsertPoleRowBefore(OCCTSurfaceRef _Nonnull surface,
                                          int32_t rowIndex,
                                          const double* _Nonnull poles,
                                          int32_t poleCount);

/// Set a pole column (without weights) on a Bezier surface. vIndex is 1-based.
bool OCCTSurfaceBezierSetPoleCol(OCCTSurfaceRef _Nonnull surface,
                                 int32_t vIndex,
                                 const double* _Nonnull poles,
                                 int32_t count);

/// Set a pole row (without weights) on a Bezier surface. uIndex is 1-based.
bool OCCTSurfaceBezierSetPoleRow(OCCTSurfaceRef _Nonnull surface,
                                 int32_t uIndex,
                                 const double* _Nonnull poles,
                                 int32_t count);

/// Set a column of weights on a Bezier surface. vIndex is 1-based. count = NbUPoles.
bool OCCTSurfaceBezierSetWeightCol(OCCTSurfaceRef _Nonnull surface,
                                   int32_t vIndex,
                                   const double* _Nonnull weights,
                                   int32_t count);

/// Set a row of weights on a Bezier surface. uIndex is 1-based. count = NbVPoles.
bool OCCTSurfaceBezierSetWeightRow(OCCTSurfaceRef _Nonnull surface,
                                   int32_t uIndex,
                                   const double* _Nonnull weights,
                                   int32_t count);
...
OCCTSurfaceRef _Nullable OCCTGeomEvalTBezierSurfaceCreate(const double* _Nonnull poles,
                                                          int32_t uCount,
                                                          int32_t vCount,
                                                          double  alphaU,
                                                          double  alphaV);
...
OCCTSurfaceRef _Nullable OCCTGeomEvalAHTBezierSurfaceCreate(const double* _Nonnull poles,
                                                            int32_t uCount,
                                                            int32_t vCount,
                                                            int32_t algDegreeU,
                                                            int32_t algDegreeV,
...
OCCTSurfaceRef _Nullable OCCTGeomFillGordonReport(const OCCTCurve3DRef _Nonnull* _Nonnull profiles,
                                                  int32_t profileCount,
                                                  const OCCTCurve3DRef _Nonnull* _Nonnull guides,
                                                  int32_t guideCount,
                                                  double  tolerance,
                                                  ...
                                                  int32_t* _Nonnull outStatus,
                                                  bool* _Nonnull outIsApproximate);
...
OCCTSurfaceRef _Nullable OCCTGeomFillNetworkSurface(
  const OCCTCurve3DRef _Nonnull* _Nonnull profiles,
  int32_t profileCount,
  const OCCTCurve3DRef _Nonnull* _Nonnull guides,
  int32_t guideCount,
  double  tolerance,
