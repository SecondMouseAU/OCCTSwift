...
void OCCTCameraProject(OCCTCameraRef cam,
                       double        wX,
                       double        wY,
                       double        wZ,
                       double*       sX,
                       double*       sY,
                       double*       sZ);
void OCCTCameraUnproject(OCCTCameraRef cam,
                         double        sX,
                         double        sY,
                         double        sZ,
                         double*       wX,
...
void OCCTCameraFitBBox(OCCTCameraRef cam,
                       double        xMin,
                       double        yMin,
                       double        zMin,
                       double        xMax,
...
int32_t OCCTSelectorPick(OCCTSelectorRef sel,
                         OCCTCameraRef   cam,
                         double          viewW,
                         double          viewH,
                         double          pixelX,
...
int32_t OCCTSelectorPickRect(OCCTSelectorRef sel,
                             OCCTCameraRef   cam,
                             double          viewW,
                             double          viewH,
                             double          xMin,
...
int32_t OCCTSelectorPickPoly(OCCTSelectorRef sel,
                             OCCTCameraRef   cam,
                             double          viewW,
                             double          viewH,
                             const double*   polyXY,
...
bool OCCTShapeGetEdgeMeshWithDrawer(OCCTShapeRef      shape,
                                    OCCTDrawerRef     drawer,
                                    OCCTEdgeMeshData* out);
...
void OCCTZLayerSettingsSetPolygonOffset(OCCTZLayerSettingsRef settings,
                                        int32_t               mode,
                                        float                 factor,
                                        float                 units);
void OCCTZLayerSettingsGetPolygonOffset(OCCTZLayerSettingsRef settings,
                                        int32_t*              mode,
                                        float*                factor,
                                        float*                units);
...
// MARK: - v0.81.0: Visualization — Quantity_Color, Quantity_ColorRGBA, Graphic3d_MaterialAspect,
...
bool OCCTPeriodCreate(int dd,
                      ...
                      int mics,
                      int* _Nonnull outSec,
                      int* _Nonnull outUSec);

/// Create a period from total seconds and microseconds
/// Returns false if values are invalid
bool OCCTPeriodCreateFromSeconds(int ss, int mics, int* _Nonnull outSec, int* _Nonnull outUSec);
...
void OCCTPeriodSubtract(int sec1,
                        int usec1,
                        int sec2,
                        int usec2,
                        int* _Nonnull outSec,
...
void OCCTDateDifference(int sec1,
                        ...
                        int sec2,
                        int usec2,
                        int* _Nonnull outPeriodSec,
                        int* _Nonnull outPeriodUSec);
...
void OCCTImageGetPixel(OCCTImageRef ref,
                       int          x,
                       int          y,
                       float* _Nonnull r,
                       float* _Nonnull g,
