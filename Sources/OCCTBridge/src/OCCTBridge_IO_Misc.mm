...
//  not cleanly one format. Public C surface unchanged; imports the same OCCTBridge_IO.h every
//  sibling file does. No symbol changes, pure file move -- see Scripts/repro/396-bridge-mm-split/
//  for how.
//
