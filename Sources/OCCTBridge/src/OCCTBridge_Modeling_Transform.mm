//
//  OCCTBridge_Modeling_Transform.mm
//  OCCTSwift
//
//  Split from OCCTBridge_Modeling.mm (#396/#819): BRepBuilderAPI_{Transform,GTransform},
//  BRepTools_*Modification. Public C surface unchanged; imports the same OCCTBridge_Modeling.h
