...
struct DistAngleChamferTests {
    ...
    func distAngleChamfer() {
        checkChamfer(angleDegrees: 45.0)  // probed 994.99999999999977
    }

    @Test("Distance-angle chamfer at 30 degrees")
    func distAngle30() {
        checkChamfer(angleDegrees: 30.0)  // probed 997.11324865405163
    }

    @Test("Distance-angle chamfer at 60 degrees")
    func distAngle60() {
        checkChamfer(angleDegrees: 60.0)  // probed 991.33974596215546
    }
}
