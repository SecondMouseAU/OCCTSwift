...
struct CenterOfMassTests {
    ...
    func propertiesAgreesWithCenterOfMass() throws {
        ...
        #expect(
            simd_distance(props.centerOfMass, com) < 1e-9,
    ...
    func inertiaIsAboutTheCentreOfMass() throws {
        ...
        #expect(
            abs(props.momentOfInertia[1][1] - aboutCentreOfMass) < 1.0,
    ...
    func agreesWithCentroid() throws {
        for shape in [
            ...
            #expect(
                simd_distance(com, centroid) < 1e-6,
